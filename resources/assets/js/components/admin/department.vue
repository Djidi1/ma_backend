        ...
        methods: {
            ...
            deleteItem(item) {
                ...
                this.$confirm(this.$t('sure_delete_item')).then(res => {
                    if (res) {
                        axios.delete('/department_delete/' + item.id);
            ...
            save() {
                if (this.editedIndex > -1) {
                    ...
                    axios.put('/department_update/' + item.id, this.editedItem)
                        .then(response => {
                    ...
                    axios.post(`/department_save`, this.editedItem)
                        .then(response => {
